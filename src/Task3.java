...
public class Task3 {
    /**
     * c 3.17
     *  so we have to find the length of array  arr.length=n
     *  greatest integer (n-1) sum of integer from 1 to n-1 =(n-1).n/2
     *  Repeated element=sum of array-sum of integers from 1 to n-1
     */
